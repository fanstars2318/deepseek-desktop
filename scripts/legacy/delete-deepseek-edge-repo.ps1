# Delete guyu23223/deepseek-edge on GitHub (requires delete_repo scope).
...
Write-Host "Step 2: Deleting guyu23223/deepseek-edge ..."
& $gh repo delete guyu23223/deepseek-edge --yes

Write-Host "Done. Verifying ..."
try {
    & $gh repo view guyu23223/deepseek-edge 2>$null
