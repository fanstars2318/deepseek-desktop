import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, u as useTranslation, S as Server, W as WifiOff, b as Wifi, r as reactExports, d as clsx, g as getDefaultExportFromCjs, s as shimExports, e as reactDomExports, R as React$2, Z as Zap, B as Button, f as Square, P as Play, F as FileText, E as ExternalLink, h as create, i as useNavigate, k as useSettingsStore } from "./index-CBGGrI33.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-B5CbN4-5.js";
import { T as TrendingUp, A as Activity } from "./trending-up-K2m7kTmm.js";
import { B as Badge } from "./badge-Dj75FUPP.js";
import { S as ScrollArea, U as Users } from "./scroll-area-DcW2aRDv.js";
...
import { C as CircleCheckBig } from "./circle-check-big-DNNdS20G.js";
...
function StatsCard({ title, value, icon: Icon2, trend, className }) {
  const getTrendIcon = () => {
    if (!trend) return null;
    if (trend.value > 0) return /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-3 w-3" });
    if (trend.value < 0) return /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-3 w-3" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { hover: true, className: cn("", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-lg bg-[var(--accent-primary)]/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-4 w-4 text-[var(--accent-primary)]" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold", children: value }),
      trend && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex items-center text-xs mt-1", getTrendColor()), children: [
        getTrendIcon(),
        ...
        trend.label && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground ml-1", children: trend.label })
      ] })
    ] })
  ] });
}
const ITEM_HEIGHT$1 = 88;
const GAP$1 = 8;
function ProviderStatusCard({ providers, className }) {
  const { t } = useTranslation();
  const getStatusIcon = (status) => {
    switch (status) {
      case "online":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "h-3 w-3" });
      case "offline":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "h-3 w-3" });
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3 w-3" });
    }
  };
  ...
  const scrollHeight = ITEM_HEIGHT$1 * 7 + GAP$1 * 6;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: cn("h-full flex flex-col", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-base", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-7 w-7 rounded-lg bg-[var(--accent-primary)]/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Server, { className: "h-4 w-4 text-[var(--accent-primary)]" }) }),
      t("dashboard.providerStats")
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "flex-1 min-h-0 p-4 pt-0", children: providers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-muted-foreground py-8", children: t("providers.noProvidersFound") }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "pr-2", style: { height: scrollHeight }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: providers.map((provider) => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm", children: provider.name })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: getStatusBadge(provider.status), className: "text-xs", children: [
                getStatusIcon(provider.status),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1", children: getStatusText(provider.status) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: t("dashboard.totalRequests") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: provider.requestCount.toLocaleString() })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: t("dashboard.successRate") }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: t("providers.latency") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: provider.latency ? `${provider.latency}ms` : "-" })
              ] })
            ] })
          ]
        },
...
function LegendContent(props) {
  var {
    contextPayload
  } = props, otherProps = _objectWithoutProperties$h(props, _excluded$h);
...
class TooltipBoundingBox extends reactExports.PureComponent {
  ...
  render() {
    ...
    var positionStyles = hasPortalFromProps ? {} : _objectSpread$v(_objectSpread$v({
    ...
    var outerStyle = _objectSpread$v(_objectSpread$v({}, positionStyles), {}, {
      visibility: !this.state.dismissed && active && hasPayload ? "visible" : "hidden"
    }, wrapperStyle);
    return (
...
var useId = (_ref = React$2["useId".toString()]) !== null && _ref !== void 0 ? _ref : useIdFallback;
...
function RequestChart({ data, className }) {
  const { t } = useTranslation();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: cn("", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-lg bg-[var(--accent-primary)]/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "h-4 w-4 text-[var(--accent-primary)]" }) }),
...
function QuickActions({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: cn("", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-lg bg-[var(--accent-primary)]/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-4 w-4 text-[var(--accent-primary)]" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          className: cn(
            ...
            proxyRunning ? "bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-950/50 dark:text-white dark:hover:bg-orange-900/50" : "dark:text-white"
          ),
          variant: proxyRunning ? "secondary" : "default",
          onClick: onToggleProxy,
          disabled: isLoading,
          children: [
            isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }) : proxyRunning ? /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { className: "mr-2 h-4 w-4 text-orange-700 dark:text-orange-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "mr-2 h-4 w-4" }),
            isLoading ? t("common.loading") : proxyRunning ? t("quickActions.stopProxy") : t("quickActions.startProxy"),
            proxyRunning && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "ml-auto", children: t("dashboard.running") })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function RecentActivity({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: cn("h-full flex flex-col", className), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "flex items-center gap-2 text-base", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-7 w-7 rounded-lg bg-[var(--accent-primary)]/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "h-4 w-4 text-[var(--accent-primary)]" }) }),
      t("dashboard.recentActivity")
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "flex-1 min-h-0 p-4 pt-0", children: activities.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-muted-foreground py-8", children: t("dashboard.noActivity") }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "pr-2", style: { height: scrollHeight }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: visibleActivities.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: cn(
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm truncate", children: item.title })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              item.statusCode && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
              ...
              onItemClick && /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-3.5 w-3.5 text-muted-foreground" })
            ] })
          ] }),
          item.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1 truncate pl-4", children: item.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground pl-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatTime(item.timestamp) }),
            item.providerName && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.providerName })
            ] }),
            item.latency !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatLatency(item.latency) })
            ] })
          ] })
        ]
      },
...
const convertLogsToActivities = (logs, providers) => {
  return logs.slice(0, 10).map((log2) => {
    const provider = log2.providerId ? providers.find((p) => p.id === log2.providerId) : void 0;
    let type = "info";
    if (log2.level === "error") type = "error";
    else if (log2.level === "warn") type = "warning";
    else if (log2.level === "info" && log2.message.includes("success")) type = "success";
    return {
      id: log2.id,
      type,
      title: log2.message,
      description: log2.data ? JSON.stringify(log2.data).slice(0, 100) : void 0,
      timestamp: log2.timestamp,
      providerName: provider?.name,
      modelName: log2.data?.model
    };
  });
};
const convertRequestLogsToActivities = (logs) => {
  return logs.slice(0, 10).map((log2) => {
    return {
      id: log2.id,
      type: log2.status === "success" ? "success" : "error",
      title: log2.model,
      description: log2.status === "error" ? log2.errorMessage : log2.userInput?.slice(0, 100),
      timestamp: log2.timestamp,
      providerName: log2.providerName,
      modelName: log2.model,
      latency: log2.latency,
      statusCode: log2.statusCode
    };
  });
};
const convertTrendToChartData = (trends) => {
...
const useDashboardStore = create((set2, get2) => ({
  proxyStatus: null,
  statistics: null,
  stats: {
    totalRequests: 0,
  ...
  error: null,
  lastUpdated: null,
  setProxyStatus: (status) => set2({ proxyStatus: status }),
  setStatistics: (statistics) => set2({ statistics }),
  setStats: (stats) => set2((state) => ({ stats: { ...state.stats, ...stats } })),
  setProviders: (providers) => set2({ providers }),
  setActivities: (activities) => set2({ activities }),
  addActivity: (activity) => set2((state) => ({
    activities: [activity, ...state.activities].slice(0, 50)
  })),
  setChartData: (data) => set2({ chartData: data }),
  setLoading: (loading) => set2({ isLoading: loading }),
  setError: (error) => set2({ error }),
  refreshData: async () => {
    const { setLoading, setError, setProxyStatus, setStatistics, setStats, setProviders, setActivities, setChartData: setChartData2 } = get2();
    setLoading(true);
    setError(null);
    try {
      ...
      const avgLatency = todayStats && todayStats.successRequests > 0 ? Math.round(todayStats.totalLatency / todayStats.successRequests) : successRequests > 0 ? Math.round((persistentStats?.totalLatency ?? 0) / successRequests) : Math.round(statistics?.avgLatency ?? 0);
      const activeAccounts = accounts?.filter((a2) => a2.status === "active").length ?? 0;
      ...
      const yesterdayTrend = trendData.find((t) => t.date === yesterday);
      ...
      const latencyTrend = yesterdayAvgLatency > 0 && todayAvgLatency > 0 ? Math.round((todayAvgLatency - yesterdayAvgLatency) / yesterdayAvgLatency * 100) : 0;
      setStats({
        totalRequests,
        successRate,
        avgLatency,
      ...
      const requestLogs = await requestLogsPromise;
      const providerSuccessCount = {};
      const providerTotalCount = {};
      for (const log2 of requestLogs) {
        if (log2.providerId) {
          providerTotalCount[log2.providerId] = (providerTotalCount[log2.providerId] || 0) + 1;
          if (log2.status === "success") {
            providerSuccessCount[log2.providerId] = (providerSuccessCount[log2.providerId] || 0) + 1;
          }
        }
      }
      ...
      if (useRequestLogTrends) {
        setChartData2(requestLogTrends.map((t) => ({
          time: t.date.slice(5),
          requests: t.total,
          success: t.success,
          failed: t.error
        ...
        setChartData2(convertTrendToChartData(trends));
      }
      set2({ lastUpdated: Date.now() });
    } catch (error) {
...
function Dashboard() {
  ...
  const handleToggleProxy = reactExports.useCallback(async () => {
  ...
  const handleAddAccount = reactExports.useCallback(() => {
    navigate("/providers");
  }, [navigate]);
  const handleToolCalling = reactExports.useCallback(() => {
    navigate("/models?tab=prompts");
  }, [navigate]);
  const handleViewLogs = reactExports.useCallback(() => {
    navigate("/logs");
  }, [navigate]);
  const handleActivityClick = reactExports.useCallback((item) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight", children: t("dashboard.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: t("dashboard.description") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            disabled: isLoading,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: cn("h-4 w-4 mr-2", isLoading && "animate-spin") }),
              t("dashboard.refresh")
            ]
          }
        )
    ...
    !isElectron && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-yellow-200 bg-yellow-50 p-4 text-sm text-yellow-800 dark:border-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: t("dashboard.browserMode") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: t("dashboard.browserModeDesc") })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-red-200 bg-red-50 p-4 text-sm text-red-600 dark:border-red-800 dark:bg-red-950 dark:text-red-400", children: error }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RequestChart, { data: chartData }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-2 items-stretch", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ProviderStatusCard, { providers }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        RecentActivity,
        {
          activities,
