...
public static class HarnessStrategyResolver
{
    public static HarnessStrategyProfile Resolve(string? strategy)
    {
        ...
        return s switch
        {
            ...
            "software-factory" or "software_factory" or "factory" => new HarnessStrategyProfile
            {
                Workflow = HarnessWorkflow.SoftwareFactory,
                InitialPhase = HarnessPhase.Execute
            },
    ...
    public static string Normalize(string? strategy)
    {
        ...
        return s switch
        {
            ...
            "software-factory" or "software_factory" or "factory" => AgentStrategies.SoftwareFactory,
