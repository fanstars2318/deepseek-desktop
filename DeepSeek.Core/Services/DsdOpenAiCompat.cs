...
/// <summary>
/// 内嵌 DSD API 请求解析（<see cref="DsdEmbeddedApiStack"/>，对齐 DSD API 文档）。
/// </summary>
public static class DsdOpenAiCompat
{
    ...
    {
        var scope = DsdAgentApiScope.Current;
        if (scope is null && !DsdAgentApiScope.HasActiveAgentRun)
            return;
